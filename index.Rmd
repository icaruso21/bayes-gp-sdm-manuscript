...
```
```{r mon, fig.height=3, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Histogram displaying displaying posterior of delta from Monte Carlo integration"}
...
Currently comprised of more than 45 core developers from a wide array of educational institutions, private entities, and research organizations, over the past 9 years the Stan project has grown to become one of the leading options for performing Bayesian inference computationally [@Stan2021].
